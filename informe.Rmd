...
## El Conjunto de Datos
  ...
  Si bien la tabla tiene 10 dimensiones, elegimos dos variables como ejes para mostrar una representación gráfica del conjunto a estudiar. Más tarde, vamos a ir sobreimponiendo las diversas "caligrafías" de las funciones de clasificación de dos variables para ver cómo cada algoritmo interpreta la frontera. 
